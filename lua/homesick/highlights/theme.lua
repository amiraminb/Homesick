...
local function build(ctx)
  ...
  local theme = lush(function(fn)
    ...
    return {
      ...
      sym"@keyword" { Keyword },
      sym"@variable" { fg = pick_syntax(Identifier.fg, moon.text) },
      ...
      sym"@variable.parameter.builtin" { fg = pick_syntax(Identifier.fg, moon.iris), italic = use_moon_syntax, bold = use_moon_syntax },
