...
function M.apply(palette, variant, scheme_name)
  ...
  local ctx = {
    ...
    cursorline_code_bg = is_night and color.bg.lighten(4) or "NONE",
    function_color = pick_syntax(color.softteal, color.moon_rose or moon.rose),
    namespace_color = pick_syntax(color.redrose, color.moon_pine or moon.pine),
    pmenu_sel_bg = color.moon_overlay or color.pmenu_bg,
